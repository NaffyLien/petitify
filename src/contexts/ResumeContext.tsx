...
export type ResumeContextValue = {
  ...
  replaceEducation: (id: number, education: import('../types/resume').EducationItem) => void
  ...
  replaceCertificate: (id: number, certificate: import('../types/resume').CertificateItem) => void
  ...
  replaceExperience: (id: number, experience: import('../types/resume').ExperienceItem) => void
  ...
  replaceProject: (id: number, project: import('../types/resume').ProjectItem) => void
